...
def main():
    ...
    # Setup paths
    input_file = Path(
        "../data/xtitched_organoid_timelapse_ch0_cytosol_ch1_nuclei-1.tif"
    )
    output_folder = Path("../data/organoid_corrected_3")
    ...
    if C > 1:
        viewer.add_image(
            ...
            blending="additive",
            contrast_limits=[
                original_frames[..., 0].min(),
                original_frames[..., 0].max(),
            ],
            visible=True,
        )
        ...
        viewer.add_image(
            ...
            blending="additive",
            contrast_limits=[
                original_frames[..., 1].min(),
                original_frames[..., 1].max(),
            ],
            visible=False,
        )
        ...
        viewer.add_image(
            ...
            blending="additive",
            contrast_limits=[
                compensated_frames[..., 0].min(),
                compensated_frames[..., 0].max(),
            ],
            visible=True,
        )
        ...
        viewer.add_image(
            ...
            blending="additive",
            contrast_limits=[
                compensated_frames[..., 1].min(),
                compensated_frames[..., 1].max(),
            ],
            visible=False,
        )
    else:
