...
class TestMainCLI:
    ...
    def test_main_verbose_flag(self):
        ...
        try:
            with patch('sys.argv', ['flowreg3d', 'tiff-reshape', '--verbose',
                                   input_path, output_path, '-z', '2']):
    ...
    def test_subcommand_routing(self):
        ...
        try:
            with patch('sys.argv', ['flowreg3d', 'tiff-reshape',
                                   input_path, output_path, '-z', '5']):
    ...
    def test_invalid_subcommand(self):
        ...
        with patch('sys.argv', ['flowreg3d', 'invalid-command']):
            with patch('sys.stderr', new=StringIO()) as mock_stderr:
                ...
                assert 'invalid choice' in error_output or 'unrecognized' in error_output
    ...
    def test_error_handling_without_verbose(self):
        ...
        with patch('sys.argv', ['flowreg3d', 'tiff-reshape',
                               'nonexistent.tif', 'output.tif', '-z', '5']):
            with patch('sys.stderr', new=StringIO()) as mock_stderr:
                result = main()
                assert result == 1
                error_output = mock_stderr.getvalue()
    ...
    def test_error_handling_with_verbose(self):
        ...
        with patch('sys.argv', ['flowreg3d', '--verbose', 'tiff-reshape',
                               'nonexistent.tif', 'output.tif', '-z', '5']):
            with patch('sys.stderr', new=StringIO()) as mock_stderr:
                result = main()
                assert result == 1
...
def test_cli_as_module():
    ...
    try:
        ...
        with patch.object(sys, 'argv', ['main.py', 'tiff-reshape',
                                        input_path, output_path,
                                        '-z', '1', '--dry-run']):
            from flowreg3d.cli.main import main
            result = main()
